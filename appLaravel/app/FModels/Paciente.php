...
class Paciente extends FModel
{
    ...
    */
    protected $fillable = ['idpaciente','nombrePaciente','apellidoPaciente','rut','sexo','fechaNacimiento','direccion'];
    ...
    */
    protected $required = ['idpaciente', 'rut'];
